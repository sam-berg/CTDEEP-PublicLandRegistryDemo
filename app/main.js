...
var FIELDNAME_NUMBER = "OBJECTID";
var FIELDNAME_TITLE = "PROPERTY";
var FIELDNAME_SHORTDESC = "DESCRIPTION";
var FIELDNAME_IMAGEURL = "THUMBNAIL";
...
function initMap(layers) {
	...
	$.each(layers, function(index,value){
        ...
        if (value.url == null || value.type == "CSV" ) {
			if (
				//SBTEST getFeatureSet(value).geometryType == "esriGeometryPoint" &&
